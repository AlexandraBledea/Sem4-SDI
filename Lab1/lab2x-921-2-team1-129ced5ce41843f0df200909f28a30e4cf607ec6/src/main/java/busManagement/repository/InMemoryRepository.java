...
//        return Optional.ofNullable(entities.putIfAbsent(entity.getId(), entity));
    ...
    public Optional<T> delete(ID id) {
        ...
        boolean idNotValid = idIsNull.test(id);
        String idIsNotValidMessage = "Id must not be null!";

        List<Pair<Boolean, String>> checkList = List.of(new Pair<>(idNotValid, idIsNotValidMessage));
