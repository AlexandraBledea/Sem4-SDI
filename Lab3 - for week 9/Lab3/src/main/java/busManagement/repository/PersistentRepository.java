...
public abstract class PersistentRepository<ID, E extends BaseEntity<ID>, DTO> extends InMemoryRepository<ID, E>{
    ...
    protected abstract void saveNode(E entity);

    protected abstract void deleteNode(Optional<E> optionalE);
    ...
    public Optional<E> delete(ID id) {
        ...
        optionalE.ifPresent((e) -> deleteNode(optionalE));
