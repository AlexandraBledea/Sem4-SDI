...
public class TicketValidatorTest {
    ...
    public void setUp() {
        ...
        ticket1 = new Ticket(1L, 1L, LocalTime.of(4, 0), 200L);
        ticket1.setId(-1L);

        ticket2 = new Ticket(1L, 1L, LocalTime.of(4, 0), 200L);
        ticket2.setId(null);

        ticket3 = new Ticket(-1L, 1L, LocalTime.of(4, 0), 200L);
        ticket3.setId(0L);

        ticket4 = new Ticket(null, 1L, LocalTime.of(4, 0), 200L);
        ticket4.setId(1L);

        ticket5 = new Ticket(1L, -1L, LocalTime.of(4, 0), 200L);
        ticket5.setId(2L);

        ticket6 = new Ticket(1L, null, LocalTime.of(4, 0), 200L);
        ticket6.setId(3L);

        ticket7 = new Ticket(1L, 1L, LocalTime.of(4, 0), -120L);
        ticket7.setId(4L);

        ticket8 = new Ticket(1L, 1L, LocalTime.of(4, 0), null);
        ticket8.setId(5L);
    }
    ...
    public void testPassagerIdNotNegative() {
        ...
        assertEquals(exc.getMessage(), "PassengerId must not be null or negative!\n");
    }
    ...
    public void testPriceNotNegative() {
        ...
        assertEquals(exc.getMessage(), "Ticket must have a non-null and not negative Price!\n");
    }
